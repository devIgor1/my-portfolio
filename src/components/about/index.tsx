        ...
        <div className="w-full min-h-screen bg-center">
          <div className="flex flex-col md:flex-row items-center justify-center min-h-screen w-full gap-20">
            <section className="flex flex-col max-w-4xl">
              ...
              <h3 className="px-3 text-2xl md:text-3xl bg-gradient-to-b from-slate-50 to-zinc-300 bg-clip-text text-transparent font-poppins font-semibold">
                I'm a guy who's passionate about{" "}
                <span className="font-bold bg-gradient-to-b from-zinc-100 to-purple-700 bg-clip-text text-transparent">
                  studying
                </span>
              ...
              <h3 className="mt-10 px-3 text-2xl md:text-3xl bg-gradient-to-b from-slate-50 to-zinc-300 bg-clip-text text-transparent font-poppins font-semibold">
            ...
            <section>
              <img
                src={retrowave}
                alt="retrowave-image"
                className="rounded-lg w-[500px] px-4"
              />
            </section>
          </div>
          <div>
